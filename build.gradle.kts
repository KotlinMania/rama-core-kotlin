...
kotlin {
    ...
    val xcf = XCFramework("RamaCore")

    macosArm64 {
        binaries.framework { baseName = "RamaCore"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaCore"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaCore"
        flattenPackage = "io.github.kotlinmania.ramacore"
    }

    android {
        namespace = "io.github.kotlinmania.ramacore"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("io.github.kotlinmania:ahash-kotlin:0.1.1")
                implementation("io.github.kotlinmania:asynk-strim-kotlin:0.1.1")
                ...
                implementation("io.github.kotlinmania:opentelemetry-sdk-kotlin:0.1.1")
                implementation("io.github.kotlinmania:opentelemetry-semantic-conventions-kotlin:0.1.1")
                implementation("io.github.kotlinmania:parking-lot-kotlin:0.1.1")
                implementation("io.github.kotlinmania:rama-error-kotlin:0.1.1")
                implementation("io.github.kotlinmania:rama-macros-kotlin:0.1.1")
                implementation("io.github.kotlinmania:rama-utils-kotlin:0.1.1")
                ...
                implementation("io.github.kotlinmania:tokio-graceful-kotlin:0.1.1")
                implementation("io.github.kotlinmania:tokio-util-kotlin:0.1.1")
                implementation("io.github.kotlinmania:tracing-kotlin:0.1.1")
                implementation("io.github.kotlinmania:tracing-opentelemetry-kotlin:0.1.1")
        ...
        val commonTest by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:quickcheck-kotlin:0.1.1")
                implementation("io.github.kotlinmania:rand-kotlin:0.1.1")
                implementation("io.github.kotlinmania:tokio-test-kotlin:0.1.1")
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-core-kotlin", version.toString())

    pom {
        name.set("rama-core-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - rama service core code, used by rama and service authors")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-core-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-core-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-core-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-core-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaCoreXCFramework",
    "assembleRamaCoreDebugXCFramework",
    "assembleRamaCoreReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseIosFatFrameworkForRamaCoreXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaCoreXCFramework",
    "assembleDebugMacosFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseMacosFatFrameworkForRamaCoreXCFramework",
    "assembleDebugTvosFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseTvosFatFrameworkForRamaCoreXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaCoreXCFramework",
    "assembleDebugWatchosFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaCoreXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaCoreXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaCoreXCFramework",
