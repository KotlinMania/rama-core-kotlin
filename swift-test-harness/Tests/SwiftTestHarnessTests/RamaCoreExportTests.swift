...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RamaCore.swiftmodule/`
...
//      `import RamaCore` above would fail at compile time.
//
//   2. The static archive `libRamaCore.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RamaCore" }` and
//      `flattenPackage = "io.github.kotlinmania.ramacore"` configuration in
...
//      via the `RamaCoreLibrary` product.
//
