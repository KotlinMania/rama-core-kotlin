...
This file is the quick-reference operating contract for rama-core-kotlin. The longer
...
rama-core-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-core`](https://crates.io/crates/rama-core). Upstream Rust is the behavioral oracle while the
